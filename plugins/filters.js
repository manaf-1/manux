...
const array = ['Alone','avan','Bot','Da','Di','Enthada','friends','Jihad','Life','love','lub','M','Mm','Myr','Myre','Nice','Ningal','Njan','Owner','Para','Please','Poda','pro','Sathyam','Thep','Umm','umma','venda','xxx','edit','Shari']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
